...
public class Golem extends Creature
{
    ...
    public void act() 
    {
        ...
        {
            playerWorld.showText("Golem has fainted...", getWorld().getWidth()/2, getWorld().getHeight()/2 + 26);
            Greenfoot.delay(30);

            //TODO (68): If the current health of the health bar of the new one creature at index 1 in player world is greater than 0...
            if(getNewOneCreature(idx).playerWorld.getHealthBar().getCurrent() > 0)
            {
    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            {
                enemy.getHealthBar().add( 70-35);
                getWorld().showText("It wasn't very effective...",getWorld().getWidth(),getWorld().getHeight()+26);
                Greenfoot.delay(30);
            }
            else
            {
    ...
    public void switchCreature(int idx)
    {
        ...
        {
            JOptionPane.showMessageDialog(null,"This creature has fainted, please choose another");
