    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            if(enemyType.equalsIgnoreCase("Rock"))
            {
                ...
                playerWorld.showText("This Attack Had No Effect...",playerWorld.getWidth()/2,playerWorld.getHeight()/2);
                Greenfoot.delay(30);
            ...
            if(enemyType.equalsIgnoreCase("Grass"))
            {
                ...
                playerWorld.showText("It Wasn't Very Effective...", getX()/2,getY()/2);
                /**
